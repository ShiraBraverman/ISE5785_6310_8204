...
class CylinderTests {
    ...
    void testConstructor() {
        // Valid cylinder
        assertDoesNotThrow(() ->
                        new Cylinder(2.0, 5.0, new Ray(new Point(0, 0, 0), new Vector(0, 0, 1))),
                "Failed constructing a correct cylinder");

        // Invalid cylinder with zero height
        assertThrows(IllegalArgumentException.class, () ->
                        new Cylinder(2.0, 0.0, new Ray(new Point(0, 0, 0), new Vector(0, 0, 1))),
                "Expected exception for zero height");

        // Invalid cylinder with negative height
        assertThrows(IllegalArgumentException.class, () ->
                        new Cylinder(2.0, -3.0, new Ray(new Point(0, 0, 0), new Vector(0, 0, 1))),
                "Expected exception for negative height");
    }
    ...
    @Test
    void testGetNormal() {
        // Cylinder with axis along the Z-axis, starting at (0, 0, 0)
        Cylinder cylinder = new Cylinder(2.0, 5.0, new Ray(new Point(0, 0, 0), new Vector(0, 0, 1)));
